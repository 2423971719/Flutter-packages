...
//    Log.e("image--","11111111111111111111111111");
//    Intent pickImageIntent = new Intent(Intent.ACTION_GET_CONTENT);
//    pickImageIntent.setType("image/*");
//    activity.startActivityForResult(pickImageIntent, REQUEST_CODE_CHOOSE_IMAGE_FROM_GALLERY);

//    MultiImageSelector.create().count(1).single().showCamera(true).start(activity, REQUEST_CODE_CHOOSE_IMAGE_FROM_GALLERY);
        new ImagePicker()
                ...
                .start(activity, REQUEST_CODE_CHOOSE_IMAGE_FROM_GALLERY); //自定义RequestCode
...
//      handleImageResult(path, false);
            ...
            if (resultList != null && resultList.size() != 0) {
                String path = resultList.get(0).getImagePath();
                handleImageResult(path, false);
            }
            return;
        }
