...
// Returns alert image for icon
  Widget _getImage() {
    ...
    double widthThis = 65.0;
    switch (type) {
      case AlertType.success:
        response = Image.asset('$kImagePath/icon_success.png',
            package: 'rflutter_alert', width: widthThis);
        break;
      case AlertType.error:
        response = Image.asset('$kImagePath/icon_error.png',
            package: 'rflutter_alert', width: widthThis);
        break;
      case AlertType.info:
        response = Image.asset('$kImagePath/icon_info.png',
            package: 'rflutter_alert', width: widthThis);
        break;
      case AlertType.warning:
        response = Image.asset('$kImagePath/icon_warning.png',
            package: 'rflutter_alert', width: widthThis);
        break;
      case AlertType.none:
        response = Container();
